...
TOOLSETS = {
    ...
    "hermes-websocket": {
        ...
        "tools": _HERMES_CORE_TOOLS + ["getProjectData", "getSelectedElements", "GetSelectedElements", "deleteTracesById", "route", "pcb_extract_bga", "drop_net", "reroute"],
        "includes": []
    },

    "hermes-websocket-pcb": {
        "description": "WebSocket PCB-focused toolset with only PCB routing primitives",
        "tools": ["getProjectData", "getSelectedElements", "GetSelectedElements", "deleteTracesById", "route", "pcb_extract_bga", "drop_net", "reroute", "memory", "todo"],
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-bluebubbles", "hermes-homeassistant", "hermes-email", "hermes-sms", "hermes-mattermost", "hermes-matrix", "hermes-dingtalk", "hermes-feishu", "hermes-wecom", "hermes-wecom-callback", "hermes-weixin", "hermes-webhook", "hermes-websocket"]
    }
}
