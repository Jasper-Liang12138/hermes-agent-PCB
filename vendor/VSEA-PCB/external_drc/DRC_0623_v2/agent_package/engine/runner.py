...
from rules.hard_rules import (
    ...
    check_h7_pad_arc_crossing,
    check_h8_pad_via_crossing,
    check_h9_via_track_crossing,
...
def run_hard_checks(board, log_fn=None, with_timing=False):
    ...
    hard_rules = [
        ...
        ("HR_DRC_PAD_ARC_CROSSING", lambda board: check_h7_pad_arc_crossing(board, log_fn=log_fn)),
        ("HR_DRC_PAD_VIA_CROSSING", lambda board: check_h8_pad_via_crossing(board, log_fn=log_fn)),
        ("HR_DRC_VIA_TRACK_CROSSING", lambda board: check_h9_via_track_crossing(board, log_fn=log_fn)),
