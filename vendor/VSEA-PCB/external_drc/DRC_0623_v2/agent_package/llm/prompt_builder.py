...
RULE_DESC = {
    ...
    "HR_DRC_PAD_ARC_CROSSING": "目标BGA区域内，焊盘不能与其他网络的同层圆弧铜走线发生实体重叠。",
    "HR_DRC_PAD_VIA_CROSSING": "目标BGA区域内，焊盘不能与其他网络过孔在共同铜层发生实体重叠。",
    "HR_DRC_VIA_TRACK_CROSSING": "目标BGA区域内，过孔不能与其他网络的直线或圆弧铜走线发生实体重叠。",
    "HR_CONNECT_BRANCH_INCOMPLETE": "从BGA焊盘出发的逃逸分支应连续走出BGA区域；如果分支在BGA内部中断、悬空或未真正逃逸到外部，则判为逃逸不完整。",
    "HR_CONNECT_VIA_ONLY_ESCAPE": "BGA焊盘连接到区域内过孔但没有走出BGA区域或连接到其他焊盘时，仅给出警告，不作为硬错误。",
